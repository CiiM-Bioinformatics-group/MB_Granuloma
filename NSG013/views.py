...
def nsg013_page(request):
    dataset = {
        'title': 'TB-Lung-Visum-NSG013',
        'species': 'Human',
        'tissue_type': 'Lung',
        'granuloma_description': 'Large Granuloma, no satellites, B-cell-cluster',
        'age': 59,
        'sex': 'M',
...
def plot_gene_image(request):
    if request.method == "POST":
        try:
            ...
            output_dir = os.path.join("frontend", "static", "generated", "H1116034")
