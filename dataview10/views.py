...
def dataview10_page(request):
    dataset = {
        'title': 'DATAVIEW10 Dataset',
        'species': 'Human',
        'tissue_type': 'Lung',
        'granuloma_description': 'Example Granuloma',
        'age': 50,
        'sex': 'F',
        'bacteria': 'M. tuberculosis',
        'slide_number': 'SLIDE-001',
        'sample_id': sampleID,
        'pubid': sampleID + 'PUB',
        'method': 'Visium',
        'default_img': f'/static/generated/010default.png',
    }
