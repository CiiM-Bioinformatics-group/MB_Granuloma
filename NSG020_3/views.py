...
def nsg020_3_page(request):
    dataset = {
        'title': 'TB-Lung-Visum-NSG020_3',
        'species': 'Human',
        'tissue_type': 'Lung',
        ...
        'sex': 'F',
        'bacteria': 'M. avium',
        'slide_number': 'V53F21-115',
        'sample_id': 'NSG020_3',
        'pubid': 'NSG020_3',
        'method': 'Visium',
        'default_img': f"images/spots/2315332.jpeg"
...
def plot_gene_image(request):
    if request.method == "POST":
        try:
            ...
            output_dir = os.path.join("frontend", "static", "generated", "2315332")
            ...
            return JsonResponse({"image_url": f"/mb-granuloma/static/generated/2315332/{gene}.png"})
